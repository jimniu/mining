                    ...
                    <div class="wbwj_dsj_box">
                        ...
                        <div class="wbwj_yhgl_list">
                            <table width="805" cellpadding="0" cellspacing="0" border="0">
                                <tr class="title">
                                    <td width="160">意见领袖名称</td>
                                    <td width="255">投放时间</td>
                                    <td width="215">投放时限</td>
                                    <td width="205">转发数</td>
                                </tr>
                                <tr>
                                	<td>郭敬明</td>
                        ...
                        <div class="mtys_xjtgys_bt">
                        	...
                        	<a href="<s:url action="leader/stepThree"/>" class="next2">上一步</a>
                        	<a href="<s:url action="leader/budget"/>" class="next2">确定</a>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
