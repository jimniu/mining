				...
				<div class="list_center">
					...
					<div class="list_right">
	                        ...
	                        <ul>
	                            ...
	                            <li>
	                                ...
	                                <span class="right">
										...
										<span>
											<a href="javascript:;" data-favorite="<s:property value="#lst[5]"/>"><img src="../images/recommend.jpg" height="12"  title="收录到我的收藏"/></a>
										</span>
										<span>
											<a href="javascript:;" data-delete="<s:property value="#lst[5]"/>"><img src="../images/sc_bt.jpg" height="12"  title="删除本文"/></a>
										</span>	                                    	
									</span>
	                                <div class="clear"></div>
	                            </li>
						...
						<div class="pagination">
							...
							<a href="../track/filter.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.sitename=<s:property value="result.sitename"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex-1"/>" class="prev" rel="prev">上一页</a>
							</s:if>
							<s:if test="#list.size()>=pagesize">
							<a href="../track/filter.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.sitename=<s:property value="result.sitename"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex+1"/>" class="next" rel="next">下一页</a>
							</s:if>
							<s:if test="#list.size()>0">
                           	<a href="../track/export.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.sitename=<s:property value="result.sitename"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex"/>" download>导出本页</a>
                           	</s:if>
						</div>
	                </div>
	                <div class="clear"></div>
