						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									</span><span><s:property value="#columnlist[0].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[0].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
								...
								<s:iterator value="#resultlist[0]">
								<li>
									<span class="left">
										<a href="<s:property value="url"/>" id="<s:property value="pageid"/>" title="[<s:property value="sitename"/>] <s:property value="title"/>" target="_blank"><span>[<s:property value="sitename"/>]</span> <s:property value="title"/></a>
									</span>
									<span class="right">
										...
										<span>
											<a href="javascript:;" data-favorite="<s:property value="id"/>"><img src="../images/recommend.jpg" height="12"  title="收录到我的收藏"/></a>
										</span>
										<span>
						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									<img src="../images/title_line.png" />
									</span><span><s:property value="#columnlist[1].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[1].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									<img src="../images/title_line.png" />
									</span><span><s:property value="#columnlist[2].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[2].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									<img src="../images/title_line.png" />
									</span><span><s:property value="#columnlist[3].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[3].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									<img src="../images/title_line.png" />
									</span><span><s:property value="#columnlist[4].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[4].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
						...
						<div class="list_one">
							<div class="list_one_title">
								<div class="title">
									...
									<img src="../images/title_line.png" />
									</span><span><s:property value="#columnlist[5].title"/></span>
								</div>
								<div class="more">
									<a href="<s:url action="track/more"/>?column.id=<s:property value="#columnlist[5].id"/>">更多&nbsp;&gt;&gt;</a>
								</div>
							</div>
							<ul>
