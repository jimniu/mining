                ...
                <div class="list_right">
                    ...
                    <div class="list_one_search">
                        <div class="list_one_search_box">
	                        ...
	                        <ul>
	                            ...
	                            <li class="text">
	                            	<span>公众号名称：</span>
	                                <span class="right">
	                                	<input type="text" name="result.wxname" value="<s:property value="result.wxname"/>"/>
	                                </span>
	                                <div class="clear"></div>
								</li>
	                            <li>
                        ...
                        <ul>
	                        ...
	                        <li>	                        	
	    						<span class="left" data-wxid="<s:property value="#lst[6]"/>">
			                    	<a href="<s:url action="wechat/detail"/>?result.id=<s:property value="#lst[5]"/>" target="_blank" id="<s:property value="#lst[0]"/>"><span>[<s:property value="#lst[2]"/>]</span><s:property value="#lst[1]"/></a>
								</span>
	                            <span class="right">
                    ...
                    <div class="pagination">
						...
						<a href="../wechat/filter.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.wxname=<s:property value="result.wxname"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex-1"/>" class="prev" rel="prev">上一页</a>
						</s:if>
						<s:if test="#list.size()>=pagesize">
						<a href="../wechat/filter.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.wxname=<s:property value="result.wxname"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex+1"/>" class="next" rel="next">下一页</a>
						</s:if>
						<s:if test="#list.size()>0">
						<a href="../wechat/export.shtml?result.columnid=<s:property value="result.columnid"/>&result.title=<s:property value="result.title"/>&result.wxname=<s:property value="result.wxname"/>&from=<s:property value="from"/>&to=<s:property value="to"/>&pageindex=<s:property value="pageindex"/>" download>导出本页</a>
						</s:if>
					</div>
                </div>
                <div class="clear"></div>
