...
<html>
	...
	<tr>
		...
		<td><a href="<s:property value="prefix"/><s:url action="wechat/detail"/>?result.id=<s:property value="#lst[5]"/>" target="_blank"><s:property value="prefix"/><s:url action="wechat/detail"/>?result.id=<s:property value="#lst[5]"/></a></td>
	</tr>
	</s:iterator>	
	</table>
	</body>
