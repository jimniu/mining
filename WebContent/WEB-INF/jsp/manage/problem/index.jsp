	...
	<div class="cont">
		...
		<div class="right">
			<div class="right_text"> 
				<form  action="<s:url action="problem/manage_index"/>" method="get"  id="form">
					<div class="gonggao_text">
						<label>标题：</label><input type="text"  value="<s:property value="temptitle"/>"  name="problem.title"/>
						<label>内容：</label><input type="text"   value="<s:property value="tempcontent"/>" name="problem.content"/>
					</div>
					<div class="button">
						<a href="javascript:;"  id="search">搜索</a>
						<a href="<s:url action="problem/manage_add"/>">增加</a>
				...
				<div class="table_div">
					<table width="918" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td><input  type="checkbox"  name="problemid"  value="<s:property value="id"/>"/></td>
							<td><s:property value="title"/></td>
							<td><s:if test="status == 0 ">未发布</s:if><s:else>已发布</s:else></td>
							<td><s:date name="ctime"  format="yyyy-MM-dd    HH:mm:ss" /></td>
							<td><a href="<s:url action="problem/manage_info"><s:param name='problem.id'  value="id"></s:param></s:url>"><img src="../images/xg_button.jpg" /></a></td>
						</tr>
						</s:iterator>
					</table>
				</div>
				<div class="fy_div_box">
					<div class="fy_div"   data-pagesize="12"  data-pageindex="<s:property value="pageindex"/>"  data-total="<s:property value="total"/>" 
							data-urlbase="../problem/manage_index.shtml?problem.title=<s:property value="problem.title"/>&problem.content=<s:property value="problem.content"/>">
					</div>			
