		...
		<div class="header_tow_samil">
			...
			<div class="right">
				<s:if test="#session.adminUser.name!=null">
                    <span><a href="<s:url action="anetwork/manage_networkinfo"><s:param name='adminUser.id'  value="#session.adminUser.id"></s:param></s:url>">
                        你好，<s:property value="#session.adminUser.name"/></a>
                    </span>
				</s:if>
				<a href="<s:url action="anetwork/manage_logout"/>"><img src="../images/header_tow_but_.jpg"/></a></div>
		</div>
	</div>
		...
		<div class="rwlb_div">
			...
			<div class="zc_text zc_text_info">
				<p class="btl"><label>账号名：</label>
					<input type="text" name="network.name" class="dis"/>
				</p>
				<p class="btl"><label>公司名称：</label>
					<input type="text" name="network.company" class="dis"/>
				</p>
				<p class="btl"><label>所属合作伙伴：</label>
					<select name="network.partnerid">
				...
				<p class="btl"><label>联系人：</label>
					<input type="text" name="network.contact" id="contact" class="dis"/>
				</p>
				<p class="btl"><label>公司电话：</label>
					<input type="text" name="network.phone"  id="phone" class="dis"/>
				</p>
				<p class="btl"><label>抓取优先级：</label>
					<input type="text" name="network.priority"  value="0" id="priority" class="dis"/>
				</p>
				<p class="btl"><label>每日资讯卡数量：</label>
					<input type="text" name="setting.dailycard"  value="3" id="dailycard" class="dis"/>
				</p>
				<p class="btl"><label>栏目允许关键词个数：</label>
					<input type="text" name="setting.columnkeyword"  value="5" id="columnkeyword" class="dis"/>
				</p>
				<p class="btl"><label>账户允许关键词总数：</label>
					<input type="text" name="setting.totalkeyword"  value="100" id="totalkeyword" class="dis"/>
				</p>
				<p class="btl"><label>栏目关键词允许修改次数：</label>
					<input type="text" name="setting.keywordchange"  value="5" id="keywordchange" class="dis"/>
				</p>
				<!--
				...
				<p class="inp_rad"><label class="fwlb_label">账号类型：</label>
					<input type="radio" name="network.type" value="1" /><label>高级账号</label>
				...
				<p class="inp_rad"><label class="fwlb_label">用户状态：</label>
					<input type="radio" name="network.status" value="0"/><label>非活动</label>
