...
<div class="box">
    ...
    <div class="cont">
       <%@ include file="../layout/left.jsp"%>
        <div class="right">
            <div class="rwlb_div">
                <div class="zc_text_top">公告添加<a href="<s:url action="message/manage_index"/>">返回</a></div>
                <div class="zc_text">
                	<form action="<s:url action="message/manage_save"/>" method="post"  id="form">
                        <p class="btl">
                        	<label>标题：</label>
                        ...
                        <p class="btl">
                        	<label>权重：</label>
                        	<input type="text" name="message.weight"  id="weight"  value="0"/>
                        </p>
                        ...
                        <input type="hidden"  name="message.scope"  id="scope"/>
                        <p class="p_button">
                        	<label>&nbsp;</label>
                    	...
                    	<div class="zc_cgceng" style="display:none">恭喜，此公告<br/>已添加成功。</div>
                    </form>
                </div>
