(function() {
    ...
    function Ja(a, b) {
        ...
        e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                h = T.lang,
                i = void 0,
                /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = A.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: ""))) : e = Oa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}": "{"
    ...
    oa = function(a) {
        ...
        return {
            get: function(c) {
                var f;
                d ? (f = z(a), f.stops = [].concat(f.stops), o(d,
                function(a, b) {
    ...
    Q.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                v = v.join(",");
                h[v] ? a = h[v].attr("id") : (g.id = a = "highcharts-" + yb++, h[v] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], o(j,
                function(a) {
        ...
        getBBox: function(a) {
            ...
            var i, j = f.style,
            k, l;
            d !== y && (l = ["", e || 0, g && g.fontSize, f.style.width].join(","), l = d === "" || Pb.test(d) ? "num:" + d.toString().length + l: d + l);
            l && !a && (b = c.cache[l]);
            if (!b) {
                if (f.namespaceURI === Ca || c.forExport) {
                    try {
                        ...
                        La && j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(P),
                        b = f.getBBox ? x({},
                        f.getBBox()) : {
                            width: f.offsetWidth,
                ...
                if (c.isSVG) {
                    ...
                    if (e) b.width = O(d * aa(h)) + O(a * X(h)),
                    b.height = O(d * X(h)) + O(a * aa(h))
                }
                c.cache[l] = b
            }
            return b
...
//        },
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) J(f, "height", u(J(f, "height") - h, 0)),
                    f.cutHeight = h;
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++) if (e = d[i], f = J(e, "zIndex"), e !== g && (D(f) > a || !q(a) && q(f))) c.insertBefore(g, e),
                h = !0;
                h || c.appendChild(g)
            }
            return h
    ...
    ua.prototype = {
        ...
        buildText: function(a) {
            ...
            c = this,
            d = c.forExport,
            e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = J(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k && k.textShadow, v = k && k.textOverflow === "ellipsis", s = g.length, S = l && !a.added && this.box, N = function(a) {
                return m ? D(m) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize: k && k.fontSize || c.style.fontSize || 12, a).h
            },
            t = function(a) {
                return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
            }; s--;) b.removeChild(g[s]); ! f && !n && !v && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e,
            function(e, f) {
                var g, m = 0,
                ...
                function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            J(s, n);
                            b.appendChild(s); ! m && f && (!ca && d && L(s, {
                                display: "block"
                            }), J(s, "dy", N(s)));
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 && k.whiteSpace !== "nowrap", S, w, q, u = [], y = N(s), r = 1, x = a.rotation, z = e, C = z.length; (o || v) && (n.length || u.length);) a.rotation = 0,
                                S = a.getBBox(!0),
                                q = S.width,
                                !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)),
                                S = q > l,
                                w === void 0 && (w = S),
                                v && w ? (C /= 2, z === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), z = e.substring(0, z.length + (S ? -1 : 1) * ta(C)), n = [z + (l > 3 ? "…": "")], s.removeChild(s.firstChild))) : !S || n.length === 1 ? (n = u, u = [], n.length && (r++, s = B.createElementNS(Ca, "tspan"), J(s, {
                                    dy: y,
                                    x: j
                                }), p && J(s, "style", p), b.appendChild(s)), q > l && (l = q)) : (s.removeChild(s.firstChild), u.unshift(n.pop())),
                                n.length && s.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            j.setState = function(a) { (j.state = k = a) ? a === 2 ? j.attr(g).css(s) : a === 3 && j.attr(h).css(p) : j.attr(e).css(n)
            };
            return j.on("click",
            function() {
                k !== 3 && d.call(j)
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            j = a.match(i)[1],
            a = Lb[j] || f && f.width && f.height && [f.width, f.height],
            g = this.image(j).attr({
                x: b,
                y: c
            }),
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (D) {
                    if (!s) a = r( - N * t) + B,
                    b = (h ? -A: 0) + B,
                    n.box = s = d ? m.symbol(d, a, b, n.width, n.height, G) : m.rect(a, b, n.width, n.height, 0, G[Qb]),
                    s.attr("fill", P).add(n);
                    s.isImg || s.attr(x({
                        width: r(n.width),
                        height: r(n.height)
                ...
                if (i) {
                    ...
                    q();
                        ...
                        z, j = function() {
                            ...
                            t = 'src="' + T.global.VMLRadialGradientURL + '" size="' + u + "," + y + '" origin="0.5,0.5" position="' + r + "," + x + '" color2="' + N + '" ';
                            q()
                        };
                        d.added ? j() : d.onAdd = j;
                        j = p
    ...
    Ta.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && N) w === "inside" && (N = -N),
            d.opposite && (N = -N),
            h = this.getMarkPath(x, r, N, m * z, g, f),
            n ? n.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(x)) i.xy = r = this.getLabelPosition(x, r, i, g, k, u, a, ga),
            this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r),
            ga && a % ga && (q = !1),
            q && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr": "animate"](r), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Qa(this, this.axis)
        }
    ...
    A.PlotLineOrBand.prototype = {
        render: function() {
            ...
            } else if (n && n.length && (a.svgElem = m = w.path(n).attr(t).add(), o)) for (v in d = function(b) {
                m.on(b,
                function(c) {
                    o[b].apply(a, [c])
                })
    ...
    va.prototype = {
        ...
        setOptions: function(a) {
            this.options = z(this.defaultOptions, this.isXAxis ? {}: this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], z(T[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            a >= c && b * 10 % c === 0 && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        a.dataMax = u(p(a.dataMax, d[0]), Fa(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
        ...
        setAxisTranslation: function(a) {
            ...
            function(a) {
                ...
                h > c && (h = 0);
                d = u(d, h);
                b.single || (f = u(f, Da(j) ? 0 : h / 2), g = u(g, j === "on" ? 0 : h)); ! a.noSharedTooltip && q(v) && (e = q(e) ? C(e, v) : v)
        ...
        setTickInterval: function(a) {
            ...
            b.min = ea(Ea(b.min)),
            b.max = ea(Ea(b.max));
            if (b.range && q(b.max)) b.userMin = b.min = u(b.min, b.max - b.range),
            b.userMax = b.max,
            b.range = null;
        ...
        unsquish: function() {
            ...
            function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(O(i.h / aa(ha * a))),
                b = j + O(a / 360),
                b < k && (k = b, g = a, e = j)
            }) : e = m(i.h);
            this.autoRotation = l;
        ...
        renderUnsquish: function() {
            ...
            !h)) {
                l.textOverflow = "clip";
                for (i = c.length; ! f && i--;) if (j = c[i], j = d[j].label) if (j.styles.textOverflow === "ellipsis" && j.css({
                    textOverflow: "clip"
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                function(b) {
                    if (h === 0 || h === 2 || {
                        1 : "left",
                        3 : "right"
                    } [h] === a.labelAlign) S = u(f[b].getLabelSize(), S)
            ...
            if (v && v.text && v.enabled !== !1) {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(v.style).add(a.axisGroup),
                a.axisTitle.isNew = !0;
                if (k) l = a.axisTitle.getBBox()[g ? "height": "width"],
                m = v.offset,
                n = q(m) ? 0 : p(v.margin, g ? 5 : 10);
        ...
        render: function() {
            ...
            if (a.hasData() || f) {
                ...
                m && o(g,
                function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new A.PlotLineOrBand(a)),
                    t = b + n,
    ...
    va.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (j >= E.hour) i[Hb](j >= E.day ? 0 : k * V(i[tb]() / k));
            ...
            i = new Aa(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), l = i[Ya](), m = i[Xa](), n = (E.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % E.day; d < c;) e.push(d),
            j === E.year ? d = gb(h + b * k, 0) : j === E.month ? d = gb(h, l + b * k) : !g && (j === E.day || j === E.week) ? d = gb(h, l, m + b * k * (j === E.day ? 1 : 7)) : d += j * k,
            b++;
            e.push(d);
            o(lb(e,
            function(a) {
    ...
    Va.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (A.Tooltip && b.tooltip.enabled) a.tooltip = new Nb(a, b.tooltip),
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !v && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
    ...
    x(A.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            y = !w && c[1][l],
            x,
            c = function() { ! w && O(q - r) > 20 && (p = h || O(u - y) / O(q - r));
                s = (n - u) / p + q;
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        ...
        x(Va.prototype, {
            onContainerPointerDown: function(a) {
                Cb(a, "onContainerTouchStart", "touchstart",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY,
            ...
            onContainerPointerMove: function(a) {
                Cb(a, "onContainerTouchMove", "touchmove",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY
            ...
            onDocumentPointerUp: function(a) {
                Cb(a, "onDocumentTouchEnd", "touchend",
                function(a) {
    ...
    nb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!o) {
                ...
                a.legendItem = o = c.text("", l ? f + g: -g, this.baseline || 0, w).css(z(a.visible ? h: i)).attr({
                    align: l ? "left": "right",
                    zIndex: 2
                }).add(a.legendGroup);
                if (!this.baseline) this.fontMetrics = c.fontMetrics(h.fontSize, o),
                this.baseline = this.fontMetrics.f + 3 + v,
            ...
            if (e && this.itemX - s + f > (m || b.chartWidth - 2 * j - s - d.x)) this.itemX = s,
            this.itemY += v + this.lastLineHeight + n,
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                if (!i) i = b.clipRect = d.clipRect(0, v, 9999, 0),
    ...
    F.prototype = {
        ...
        getContainer: function() {
            ...
            a || la(13, !0);
            c = D(J(a, "data-highcharts-chart")); ! isNaN(c) && Y[c] && Y[c].hasRendered && Y[c].destroy();
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a)) d.chartWidth = e = u(0, r(a)),
            d.hasUserSize = !!e;
            if (q(b)) d.chartHeight = f = u(0, r(b)); (za ? mb: L)(d.container, {
                width: e + "px",
                height: f + "px"
            },
            za);
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                ...
                height: u(0, V(this.plotSizeY - u(d, h[2]) / 2 - c))
            };
            a || o(this.axes,
            function(a) {
                a.setAxisSize();
        ...
        drawChartBox: function() {
            ...
            if (l) h ? h.animate(t) : this.plotBGImage = b.image(l, p, o, q, u).add();
            w ? w.animate({
                width: r.width,
                height: r.height
    ...
    R.prototype = {
        ...
        translate: function() {
            ...
            h = !!this.modifyValue,
            i = a.pointPlacement,
            j = i === "between" || ra(i), k = a.threshold, l = a.startFromThreshold ? k: 0, m, n, v, o = Number.MAX_VALUE, a = 0; a < g; a++) {
                var r = f[a],
                x = r.x,
                t = r.y;
                n = r.low;
                var w = b && e.stacks[(this.negStacks && t < (l ? 0 : k) ? "-": "") + this.stackKey];
                if (e.isLog && t !== null && t <= 0) r.y = t = null,
                la(10);
                ...
                n === l && (n = p(k, e.min)),
                e.isLog && n <= 0 && (n = null),
                r.total = r.stackTotal = w.total,
                r.percentage = w.total && r.y / w.total * 100,
                r.stackY = t,
                w.setOffset(this.pointXOffset || 0, this.barW || 0);
                r.yBottom = q(n) ? e.translate(n, 0, 1, 0, 1) : null;
                h && (t = this.modifyValue(t, r));
                r.plotY = n = typeof t === "number" && t !== Infinity ? C(u( - 1E5, e.translate(t, 0, 1, 0, 1)), 1E5) : y;
        ...
        drawPoints: function() {
            ...
            v = !!g.marker, a = q && n.enabled === y || n.enabled, o = g.isInside, a && e !== y && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || m, h = a.r, i = p(n.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show": "hide"](!0).animate(x({
                x: d - h,
                y: e - h
            },
            k.symbolName ? {
    ...
    xa = ka(R, {
        ...
        animate: function(a) {
            ...
            e = {};
            if (ca) a ? (e.scaleY = 0.001, a = C(b.pos + b.len, u(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len: e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX": "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
            b = a.chart;
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        l = this.visible && (a.series.forceDL || f.isInsidePlot(h, r(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l) d = x({
            x: g ? f.plotWidth - i: h,
            ...
            for (F = 2; F--;) {
                ...
                if (K) {
                    ...
                    for (G = 0; G < K; G++) {
                        ...
                        B - t < f ? E[3] = u(r(t - B + f), E[3]) : B + t > h - f && (E[1] = u(r(B + t - h + f), E[1])),
                        A - b / 2 < 0 ? E[0] = u(r( - A + b / 2), E[0]) : A + b / 2 > i && (E[2] = u(r(A + b / 2 - i), E[2]))
                    }
                }
            }
            if (Fa(E) === 0 || this.verifyDataLabelOverflow(E)) this.placeDataLabels(),
            x && g && o(this.points,
            function(b) {
                j = b.connector;
                w = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible) D = y._attr.visibility,
                B = y.connX,
                A = y.connY,
                k = l ? ["M", B + (w[6] === "left" ? 5 : -5), A, "C", B, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", B + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]],
                j ? (j.animate({
                    d: k
