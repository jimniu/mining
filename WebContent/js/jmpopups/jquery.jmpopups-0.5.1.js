...
(function($) {
    ...
    function showPopupLayerContent(popupObject, newElement, data) {
		...
		var popupHeader = "<div class=\"popup-header\">\r\n<h2>"+popupObject.title+"</h2>\r\n"
						+ "<a href=\"javascript:;\" onclick=\"$.closePopupLayer('"+popupObject.name+"')\" title=\"Close\" class=\"close-link\"><img src=\"../js/jmpopups/guanbi.png\" border=\"0\"></a>\r\n"
						+ "<br clear=\"all\" />\r\n</div>\r\n";
		...
		//popupElement.draggable({handle: '.popup-header'});
    }
